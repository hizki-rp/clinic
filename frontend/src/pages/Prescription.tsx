...
const PrescriptionPage = () => {
    ...
    const handlePrint = () => {
        // Record print timestamp (in real implementation, this would call the backend)
        const printTime = new Date().toISOString();
        console.log(`Prescription printed at: ${printTime}`);
        
        window.print();
        
        // In real implementation, update the prescription record with print info
        // await updatePrescriptionPrintStatus(patient.id, printTime, currentUser.id);
    };
            ...
            <main className="flex flex-col items-center bg-gray-200 p-4 sm:p-8 print-container">
                ...
                <div className="prescription-paper">
                    ...
                    <div className="relative z-10 h-full">
                        ...
                        {/* Title and Prescription Number */}
                        <div className="absolute top-[2.2in] left-8 w-[calc(100%-4rem)] flex justify-between items-center">
                            <h2 className="font-bold uppercase text-base tracking-widest text-gray-800">
                                Prescription Paper
                            </h2>
                            <div className="text-right">
                                <div className="text-sm font-bold text-indigo-700">RX-001</div>
                                <div className="text-xs text-gray-600">Prescription Number</div>
                            </div>
                        </div>
                        ...
                        <div className="absolute bottom-8 left-8 w-[calc(100%-4rem)] grid grid-cols-2 gap-x-10 text-sm">
                            <div>
                                ...
                                <div className="space-y-3">
                                    ...
                                    <LineField label="License Number" value="MD-12345" />
                                    <LineField label="Date" value={new Date().toISOString().split('T')[0]} />
                                    <LineField label="Valid Until" value={new Date(Date.now() + 30 * 24 * 60 * 60 * 1000).toISOString().split('T')[0]} />
                                </div>
